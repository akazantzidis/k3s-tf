...
| <a name="input_private_ssh_key"></a> [private\_ssh\_key](#input\_private\_ssh\_key) | The path is stored the private ssh key which matches the ssh authorized keys which were set | `string` | n/a | yes |
