...
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | Cluster name. | `string` | `"test-cluster"` | no |
...
| <a name="input_k3s_disable"></a> [k3s\_disable](#input\_k3s\_disable) | k3s addons disable configuration | `list(string)` | <pre>[<br>  "traefik",<br>  "servicelb",<br>  "local-storage"<br>]</pre> | no |
